...
const $Ref = (Predicate = Any_1.$Any) => {
    ...
    const map = {
        [name]: (obj) => {
            return Predicate ? (0, query_1.If)((0, query_1.IsRef)(obj), (0, query_1.If)((0, query_1.Exists)(obj), (0, query_1.IsRef)(obj), Predicate((0, query_1.Get)(obj))), false) : (0, query_1.IsRef)(obj);
        }
    };
    return map[name];
};
