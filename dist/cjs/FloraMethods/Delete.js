...
const Delete = (ref, $Predicate = FloraTypes_1.$Any) => {
    return (0, Flora_1.Fx)([[ref, (0, FloraTypes_1.$Ref)((0, FloraTypes_1.$Document)($Predicate))]], (0, FloraTypes_1.$Document)($Predicate), (ref) => q.If(q.Exists(ref), q.Delete(ref), (0, Flora_1.FloraException)({
